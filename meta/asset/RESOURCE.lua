...
---@field Icon? ATLAS_CELL | ATLAS_CELL_ASSET Serialized asset ID
...
---@field ResourceVisualPrefabList? PREFAB[] | PREFAB_ASSET[] Serialized list of asset IDs (used for multiple units display)
---@field IndividualResourceVisualPrefabList? PREFAB[] | PREFAB_ASSET[] Serialized list of asset IDs (used for single unit display)
