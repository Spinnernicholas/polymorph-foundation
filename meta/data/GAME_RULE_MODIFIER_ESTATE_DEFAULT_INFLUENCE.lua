...
local GAME_RULE_MODIFIER_ESTATE_DEFAULT_INFLUENCE = {}

GAME_RULE_MODIFIER_ESTATE_DEFAULT_INFLUENCE.DataType = "GAME_RULE_MODIFIER_ESTATE_DEFAULT_INFLUENCE"

---Class methods and properties go here

return GAME_RULE_MODIFIER_ESTATE_DEFAULT_INFLUENCE