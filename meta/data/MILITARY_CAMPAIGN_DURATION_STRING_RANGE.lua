...
---@field Value? integer Serialized integer value

local MILITARY_CAMPAIGN_DURATION_STRING_RANGE = {}

MILITARY_CAMPAIGN_DURATION_STRING_RANGE.DataType = "MILITARY_CAMPAIGN_DURATION_STRING_RANGE"

---Class methods and properties go here

return MILITARY_CAMPAIGN_DURATION_STRING_RANGE