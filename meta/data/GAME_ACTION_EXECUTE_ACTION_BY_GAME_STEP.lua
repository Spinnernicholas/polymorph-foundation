...
---@field DataType 'GAME_ACTION_EXECUTE_ACTION_BY_GAME_STEP' The name of this data type (always "GAME_ACTION_EXECUTE_ACTION_BY_GAME_STEP")
...
GAME_ACTION_EXECUTE_ACTION_BY_GAME_STEP.DataType = "GAME_ACTION_EXECUTE_ACTION_BY_GAME_STEP"
