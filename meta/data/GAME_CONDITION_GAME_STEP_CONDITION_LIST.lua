...
---@field DataType 'GAME_CONDITION_GAME_STEP_CONDITION_LIST' The name of this data type (always "GAME_CONDITION_GAME_STEP_CONDITION_LIST")
...
GAME_CONDITION_GAME_STEP_CONDITION_LIST.DataType = "GAME_CONDITION_GAME_STEP_CONDITION_LIST"
