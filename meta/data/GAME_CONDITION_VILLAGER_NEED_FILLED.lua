...
---@field DataType 'GAME_CONDITION_VILLAGER_NEED_FILLED' The name of this data type (always "GAME_CONDITION_VILLAGER_NEED_FILLED")
...
GAME_CONDITION_VILLAGER_NEED_FILLED.DataType = "GAME_CONDITION_VILLAGER_NEED_FILLED"
