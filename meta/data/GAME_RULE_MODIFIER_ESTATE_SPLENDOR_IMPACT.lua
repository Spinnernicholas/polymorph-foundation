...
---@field DataType 'GAME_RULE_MODIFIER_ESTATE_SPLENDOR_IMPACT' The name of this data type (always "GAME_RULE_MODIFIER_ESTATE_SPLENDOR_IMPACT")
...
GAME_RULE_MODIFIER_ESTATE_SPLENDOR_IMPACT.DataType = "GAME_RULE_MODIFIER_ESTATE_SPLENDOR_IMPACT"
