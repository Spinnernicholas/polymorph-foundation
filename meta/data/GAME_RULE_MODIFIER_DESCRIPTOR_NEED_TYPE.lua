...
---
---Deprecated names:
--- GAME_RULE_MODIFIER_DESCRIPTOR_RESOURCE_TYPE
---
---Category: Data
---
...
GAME_RULE_MODIFIER_DESCRIPTOR_NEED_TYPE.DataType = "GAME_RULE_MODIFIER_DESCRIPTOR_NEED_TYPE"

---Class methods and properties go here

return GAME_RULE_MODIFIER_DESCRIPTOR_NEED_TYPE