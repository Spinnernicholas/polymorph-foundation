...
---@field DataType '"GAME_ACTION_GIVE_RESOURCE_LIST_PER_VILLAGER_STATUS"' The name of this data type (always "GAME_ACTION_GIVE_RESOURCE_LIST_PER_VILLAGER_STATUS")
