...
---@field DataType 'GAME_CONDITION_TRADE_RESOURCE_QUANTITY' The name of this data type (always "GAME_CONDITION_TRADE_RESOURCE_QUANTITY")
...
GAME_CONDITION_TRADE_RESOURCE_QUANTITY.DataType = "GAME_CONDITION_TRADE_RESOURCE_QUANTITY"
