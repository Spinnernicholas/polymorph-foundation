...
---@field DataType 'GAME_ACTION_CONDITIONAL_ACTION_LIST' The name of this data type (always "GAME_ACTION_CONDITIONAL_ACTION_LIST")
...
GAME_ACTION_CONDITIONAL_ACTION_LIST.DataType = "GAME_ACTION_CONDITIONAL_ACTION_LIST"
